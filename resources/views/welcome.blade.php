            ...
            @if (Route::has('login'))
                <div class="w-100 z-10 flex p-6 text-right sm:fixed sm:right-0 sm:top-0">
                    ...
                    <a href="{{ url('/about') }}"
                        ...
                        Us</a>
                    <a href="{{ url('/product') }}"
                        class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-gray-400 dark:hover:text-white">Product</a>
                    <a href="{{ url('/partners') }}"
